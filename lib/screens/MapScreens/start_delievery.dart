...
import 'package:kaana_rider/screens/MapScreens/delivery_arrived2.dart';
...
class StartDeliveryScreen extends StatelessWidget {
  StartDeliveryScreen({Key? key}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(CustomAssets.groupprofile),
